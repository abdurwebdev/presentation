  ...
  return (
    <div className='flex flex-col items-start justify-start pt-20 h-screen bg-black'>
      ...
      <i className="ri-arrow-left-long-line"></i>
       ...
       <h1 className='text-white text-3xl px-12 font-bold'>🔸 Step 1: Connect MongoDB
       </h1>
...
<h1 className='text-white mt-2 text-3xl px-12 font-bold'>🔸 Step 2: Define a Schema
</h1>
      <pre className="bg-zinc-900 mx-12 text-green-400 text-sm p-4 rounded-md w-[92%]  mt-4 overflow-x-auto">
  <code>
