...
const page = () => {
  return (
    <div className='flex flex-col items-start justify-start pt-20 h-screen bg-black'>
      ...
      <h1 className='text-white text-3xl font-bold px-12'>🔐 Login</h1>
<p className='text-white px-12 text-2xl font-bold mt-5 leading-relaxed'>
Flow: <br />

User enters email and password <br />

POST request to /api/login <br />

Backend:

Finds user by email <br />

Compares password with hashed password <br />

If valid, generates JWT (token) <br />

Sends token in response <br />
