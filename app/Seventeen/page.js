...
const page = () => {
  return (
    <div className='flex flex-col items-start justify-start pt-20 h-screen bg-black'>
      ...
      <h1 className='text-white text-3xl px-12 font-bold'>🔐 JSON  <span id='main'>Web Tokens (JWT)</span></h1>
      <p className='text-white px-12 text-2xl font-bold mt-5 leading-relaxed'> 🔹 What is JWT? <br />
A compact, self-contained token used for authentication <br />

Encodes user data using a secret key <br />
</p>
<h1 className='text-white text-3xl px-12 font-bold'>STRUCTURE</h1>
<p className='text-white px-12 text-2xl font-bold mt-5 leading-relaxed'>Header.Payload.Signature</p>
