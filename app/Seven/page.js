...
const page = () => {
  return (
    <div className='flex flex-col items-start justify-start pt-20 h-screen bg-black'>
      ...
      <h1 className='text-white text-3xl font-bold px-12'>✅ Example Flow</h1>
<p className='text-white px-12 text-2xl font-bold mt-5 leading-relaxed'>
User fills a registration form → Data sent to Express.js backend → Validated → Saved to database → Response sent back to user.
</p>
